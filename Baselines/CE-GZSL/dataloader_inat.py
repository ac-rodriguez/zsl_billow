...
class H5Dataset_inat(torch.utils.data.Dataset):
    def __init__(self,opt=None,
        ...
        self.opt = opt
        if opt.dataset == 'inat2021mini' and split == 'train':
            split = 'train_mini'
        ...
        self.year = dict_years[self.opt.dataset]
        ...
        if self.is_load_in_memory:
            ...
            data_feat = []
            data_label = []
            for feat, label, _ in tqdm.tqdm(loader, desc=f'Loading inat{self.year} {self.split}'):
    ...
    def _get_split_files(self, split):
        ...
        if self.year == '2017':
            h5_file = self.base_path+"/2017/inat2017_aves_train_val_resnet101.h5"
            ...
            h5_file = self.base_path+"/2021/inat2021_aves_train_mini_resnet101.h5"
        
            if split == 'train':
                h5_file = self.base_path+"/2021/inat2021_aves_train_resnet101.h5"
                ...
                h5_file = self.base_path+"/2021/inat2021_aves_val_resnet101.h5"
                file_classes = f'{self.base_path}/2021/zsl_splits/seen_classes.txt'
    ...
    def __getitem__(self, index):
        ...
        assert sci_name == self.get_sci_name_from_filename(file)
